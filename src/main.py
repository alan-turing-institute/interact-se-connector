...
def get_args() -> ArgumentParser:
    ...
    options_grp.add_argument(
        '--force',
        action='store_true',
        help=('Updates the entire index for this application, even if no change is detected'
    ...
    options_grp.add_argument(
        '--dry-run',
        action='store_true',
        help=('Do not make any changes to the Interact Search Engine index. Run through each step'
